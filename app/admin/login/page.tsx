  ...
  return (
    <div className="min-h-screen flex" style={{ fontFamily: "var(--font-body), Jost, system-ui, sans-serif" }}>
      ...
      <div className="hidden lg:flex lg:w-[52%] relative flex-col items-center justify-center p-16 overflow-hidden bg-[#2E2820]">
        ...
        {/* Corner marks */}
        <div className="absolute top-8 left-8 flex flex-col gap-1 opacity-30">
          <div className="w-8 h-px bg-[#C4B5A5]" />
          <div className="w-4 h-px bg-[#C4B5A5]" />
        </div>
        <div className="absolute top-8 right-8 flex flex-col items-end gap-1 opacity-30">
          <div className="w-8 h-px bg-[#C4B5A5]" />
          <div className="w-4 h-px bg-[#C4B5A5]" />
        </div>
        <div className="absolute bottom-8 left-8 flex flex-col gap-1 opacity-30">
          <div className="w-4 h-px bg-[#C4B5A5]" />
          <div className="w-8 h-px bg-[#C4B5A5]" />
        </div>
        <div className="absolute bottom-8 right-8 flex flex-col items-end gap-1 opacity-30">
          <div className="w-4 h-px bg-[#C4B5A5]" />
          <div className="w-8 h-px bg-[#C4B5A5]" />
        </div>
        ...
        <div className="relative z-10 text-center max-w-sm">
          ...
          <div className="grid grid-cols-3 gap-3 mb-10">
            {[
              ...
              <div key={s.label} className="border border-[#C4B5A5]/15 bg-[#C4B5A5]/5 p-4">
                <div
                ...
                <div className="text-[9px] uppercase tracking-[0.2em] text-[#C4B5A5]/50">{s.label}</div>
              </div>
            ))}
          </div>
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 border border-[#C4B5A5]/20">
            ...
            <span className="text-[9px] text-[#C4B5A5]/60 uppercase tracking-[0.2em]">System operational</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-[#F8F5F0] relative">
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-10">
            ...
            <div>
              <div
                ...
                style={{ fontFamily: "var(--font-display), Georgia, serif", fontSize: "18px" }}
              >
                MAJESTIC
              </div>
              <div className="text-[9px] uppercase tracking-[0.3em] text-[#7A6E64]">Admin Console</div>
            </div>
          </div>

          <div className="mb-10">
            <p className="text-[10px] font-medium uppercase tracking-[0.3em] text-[#B8897A] mb-3">Admin Access</p>
            <h2
              className="text-[#2E2820] leading-tight mb-2"
              style={{ fontFamily: "var(--font-display), Georgia, serif", fontSize: "36px", fontWeight: 400 }}
            >
              Sign In
            </h2>
            <p className="text-sm font-light text-[#7A6E64]">Enter your credentials to access the dashboard.</p>
          </div>
          ...
          <div className="mt-8 p-5 border border-[#E8E0D5] bg-white">
            <p className="text-[9px] font-medium uppercase tracking-[0.25em] text-[#C4B5A5] mb-3">Default Credentials</p>
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-[11px] font-light text-[#7A6E64]">Email</span>
                <span className="text-[11px] font-medium text-[#2E2820]">admin@majestic.com</span>
              </div>
