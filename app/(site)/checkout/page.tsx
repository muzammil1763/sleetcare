...
export default function Checkout() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    if (!isValidPhone(form.phone)) {
      toast({ title: "Invalid phone", description: "Enter a valid Pakistani number e.g. 0300 1234567", variant: "destructive" });
      return;
    }
